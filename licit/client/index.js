...
function main(): void {
  ...
  const runTime = null;
  ReactDOM.render(<Licit data={docJSON} debug={false} docID={0} embedded={false} height={'100vh'} onChange={onChangeCB} onReady={onReadyCB}  runtime={runTime} width={'100vw'}/>, el);
}
